...
<h2 class="ta-c wra-h">查询充值记录</h2>
   <form action="rechargeOrderAction_findAllByTime" method="get">
   ...
   <div>
  		...
  		<%
  		 ...
  		 %>
         <a href="${pageContext.request.contextPath }/rechargeOrderAction_findAllByTime.action">首页</a>
         <%
            if(currentPage!=1){
          %>
          <a href="${pageContext.request.contextPath }/rechargeOrderAction_findAllByTime.action">上一页</a>
          <%
             }
           %>
         <%
          ...
          %>
         <a href="${pageContext.request.contextPath }/rechargeOrderAction_findAllByTime.action">下一页</a>
         <%
             }
          %>
          <%
             if(currentPage!=pages.getPageTotal()){
          %>
          <a href="${pageContext.request.contextPath }/rechargeOrderAction_findAllByTime.action">尾页</a>
          <%
             }
          %>
      </div>
